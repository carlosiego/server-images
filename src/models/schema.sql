...
CREATE INDEX idx_prod_image ON IMGPRODUCTS(product_id);
CREATE INDEX idx_image ON IMAGES(id);
CREATE INDEX idx_product ON PRODUCTS(code)

-- CREATE INDEX idx_imglocations ON IMGLOCATIONS(id)
-- CREATE INDEX idx_imgprodlocations ON IMGPRODUCTSLOCATIONS(product_id)
